		...
		<nav id="side-cart">
			...
			<?php if (sizeof(WC()->cart->cart_contents)>0) : ?>
				...
				<div class="buttons item">
					...
					<!-- <a href="<?php echo esc_url( WC()->cart->get_checkout_url() ); ?>" class="btn large full accent"><?php _e('Checkout2', 'north'); ?></a> -->
				</div>
			<?php else: ?>
