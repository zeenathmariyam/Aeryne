...
$shop_product_listing = ot_get_option('shop_product_listing', 'style2');
...
<?php
	...
	//small-12
?>
<div itemscope itemtype="<?php echo woocommerce_get_product_schema(); ?>" <?php post_class("post product item small-12 ".$columns ." columns ". $shop_product_listing); ?>>
	<?php
		/**
	...
	?>
	<figure class="product_thumbnail <?php echo esc_attr($class); ?>" id="asc-product_thumb">	
	...
	<div class="product_after_title">
		<div class="product_after_shop_loop_price">
            ...
            if ( ! is_admin() ) {
                global $product, $post;
                if ($product->get_display_price() == 0) {
                    $my_post = array(
                        'ID' => $post->ID
                    );
       ...
       <div class="product-count" id="<?php //echo $yit_get_product_id(  $product ); ?>"><?php echo YITH_WCWL()->count_add_to_wishlist(yit_get_product_id(  $product));  ?></div>
