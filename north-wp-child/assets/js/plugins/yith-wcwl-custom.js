...
counter.html( data.count );
	...
	{
	$('.wrapper-count').addClass('twodigits');
	}
	else if(data.count==0)
	{
	$('.wrapper-count').removeClass('twodigits');
	$('.wrapper-count').removeClass('defaultcount');
	$('.wrapper-count').addClass('zerocount');
	}
	else
	{
	$('.wrapper-count').removeClass('twodigits');
	$('.wrapper-count').removeClass('zerocount');
	$('.wrapper-count').addClass('defaultcount');
	}
...
/***wishlist counter -zee ***/
/***wishlist counter single product -zee ***/
/*
jQuery( document ).ready( function( $ ){
$(document).on( 'added_to_wishlist removed_from_wishlist', function(){
var product_counter = $('.product-count');

$.ajax({
url: yith_wcwl_l10n.ajax_url,
data: {
action: 'yith_wcwl_update_wishlist_count_product'
},
dataType: 'json',
success: function( data ){
product_counter.html( data.count);
$('.product-count').addClass('hel'+data.count+'lo');
},
beforeSend: function(){
product_counter.block();
},
complete: function(){
product_counter.unblock();
}
})
} )
});*/
